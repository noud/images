...
hideOverlay()})})(jQuery);;var RunCallbackFunction=function(){};$(document).ready(function(){$('.emoticon').live('click',function(){if(window.opener.$!==undefined&&window.opener.$.mydefchatconn!==undefined){window.opener.$.mydefchatconn("select_emoticon",$(this).data('emoticon'));}else{window.opener.use_uploaded_emoticon($(this).data('emoticon'));}
window.opener.focus();window.close();});$("select.navselect").change(function(){if($(this).val()){window.location=$(this).val();}});$('a[rel*=facebox]').live("mousedown",function(){$(this).facebox();});});;$(document).ready(function(){$('a[href="#"]').live('click',function(){return false;});});;$.facebox.settings.closeImage='/images/closebutton.png';$.facebox.settings.loadingImage='/facebox/loading.gif';