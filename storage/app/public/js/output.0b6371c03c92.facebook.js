...
hideOverlay()})})(jQuery);;var RunCallbackFunction=function(){};$(document).ready(function(){$('body').on('click','.emoticon',function(){if(window.opener.$!==undefined&&window.opener.$.mydefchatconn!==undefined){window.opener.$.mydefchatconn("select_emoticon",$(this).data('emoticon'));}else{window.opener.use_uploaded_emoticon($(this).data('emoticon'));}
window.opener.focus();window.close();});$("select.navselect").change(function(){if($(this).val()){window.location=$(this).val();}});$('body').on('mousedown','a[rel*=facebox]',function(){$(this).facebox();});});;$(document).ready(function(){$('body').on('click','a[href="#"]',function(){return false;});});;$.facebox.settings.closeImage='/images/closebutton.png';$.facebox.settings.loadingImage='/facebox/loading.gif';